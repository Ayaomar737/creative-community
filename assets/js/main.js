...
(function ($) {
      ...
      swiperActivation: function(){
        ...
        $(document).ready(function(){ 
          var swiper = new Swiper(".rts-brandSlider-2", {
              ...
              freeMode: true, // حركة ناعمة
              freeModeMomentum: false, // نمنع الزخم
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      services.forEach(service => {
          service.addEventListener("click", function () {
              ...
              serviceText.innerHTML = newText.replace(/\n/g, "<br>");
          });
      });
  });
  ...
  function toggleDetails(client, show) {
    const box = client.querySelector('.client-box');
    const details = client.querySelector('.details');
